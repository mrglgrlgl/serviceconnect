    ...
    <div class="w-full md:w-8/12 space-y-6 mx-auto">
        <form action="{{ route('save-step3') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="form-group mb-4">
                <label for="government_id_front" class="block text-gray-700">Government ID (Front)</label>
        ...
        @enderror
            ...
            <div class="form-group mb-4">
                ...
                <input type="file" class="form-control w-full px-3 py-2 border rounded" id="nbi_clearance" name="nbi_clearance" onchange="previewImage(event, 'nbi_clearance_preview')">

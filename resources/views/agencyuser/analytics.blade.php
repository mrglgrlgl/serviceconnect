...
<div class="bg-background">
    ...
    <div class="flex flex-col md:flex-row mt-4 gap-4">
        ...
        <div class="bg-white p-4 rounded-lg shadow w-full flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-primary">Completion Rate</h2>
                <div class="mt-2">
        ...
        <div class="bg-white p-4 rounded-lg shadow w-full flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-primary">Most Loyal Seeker</h2>
                <div class="mt-2">
                    <p class="text-2xl font-bold">{{ $mostLoyalSeeker ? $mostLoyalSeeker->name : 'N/A' }}</p>
                </div>
            </div>
            <div class="text-right">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 mt-4 gap-4">
        ...
        <!-- Frequently Used Employees Pie Chart -->
        <div class="bg-white p-4 rounded-lg shadow w-full">
            <h2 class="text-xl font-semibold text-primary">Frequently Used Employees</h2>
            <div class="mt-4">
    ...
    new Chart(satisfactionCtx, {
        type: 'bar',
        data: {
            labels: ['Communication', 'Fairness', 'Quality of Service', 'Professionalism', 'Cleanliness & Tidiness', 'Value for Money'],
            datasets: [{
                label: 'Ratings',
                data: [
    ...
    // Frequently Used Employees Chart (pie chart)

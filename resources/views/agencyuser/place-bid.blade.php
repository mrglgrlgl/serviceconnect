    ...
    <div class="flex flex-col items-center">
        ...
        <form action="{{ route('bids.store') }}" method="POST" class="max-w-xl mx-auto">
            ...
            <div class="flex items-center p-2">
                <span class="material-icons text-custom-light-blue">request_quote</span>
                Price Range: 
            ...
            <!-- Button Section -->
            <div class="pt-4 flex items-center justify-center mt-4 space-x-4">
                <button type="button" onclick="window.history.back()" class="bg-gray-300 text-gray-700 h-12 px-6 rounded-md font-semibold shadow-md hover:bg-gray-400 transition duration-300">
                    Cancel
                </button>

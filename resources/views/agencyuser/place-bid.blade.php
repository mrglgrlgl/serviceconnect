        ...
        <div class="flex flex-col items-center">
            ...
            <form action="{{ route('bids.store') }}" method="POST" class="max-w-xl mx-auto">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="bid_amount" name="bid_amount" class="block mt-1 w-full px-3 py-2 border-gray-300 rounded-md" type="number" required />
                ...
                <div class="block mt-4">
                    <label for="agreed_to_terms" class="flex items-start">
                        <input id="agreed_to_terms" type="checkbox" class="mt-1 checkbox-align rounded border-gray-300 text-custom-light-blue shadow-sm focus:ring-custom-light-blue" name="agreed_to_terms" required>

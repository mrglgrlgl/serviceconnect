    ...
    <div class="grid grid-cols-1 md:grid-cols-2 w-full mx-auto pb-6">
        ...
        <div class="md:col-span-1 order-1 md:order-1 p-16 border border-r-0 bg-white border-l-lg border-r-none border-gray-300">
            <form method="POST" action="{{ route('agency.login') }}">
                ...
                <div class="text-3xl text-center text-custom-header mb-4">Agency User Login</div>
        ...
        <!-- Agency User Information or Branding on the Right -->
        <div class="md:col-span-1 order-2 md:order-2 p-6 flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat rounded-r-lg bg-gradient-to-b from-sky-900 to-cyan-600">
            <div class="text-center justify-center">
                <div class="pb-2">
                    <span class="justify-center px-2 text-white text-xl">Agency User Portal</span>
                </div>
                <div class="pb-8">
                    <span class="justify-center px-2 text-white font-semibold text-xl">Manage your agency's tasks and profile</span>
                </div>
            </div>
        </div>
    </div>

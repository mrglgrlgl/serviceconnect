    ...
    <div class="container mx-auto my-10 max-w-2xl">
        ...
        <form action="{{ route('agency.employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="position" class="block text-lg text-gray-700">Position</label>
                ...
                <div>
                    <label for="birthdate" class="block text-lg text-gray-700">Birthdate</label>
            ...
            <!-- Photo Field -->
            <div class="mt-6">
                <label for="photo" class="block text-lg text-gray-700">Photo</label>
            ...
            <div class="mt-6">
                <label class="block text-gray-700">Assign Services</label>
                <div class="mt-2">

                    ...
                    <div class="w-full">
                        <div class="bg-white shadow-sm p-6 border border-gray-300">
                            ...
                            @if ($channel->is_task_completed === 'true')
                                <div class="h-12 flex items-center rounded-t-lg rounded-b-none shadow-sm p-6 bg-green-100 text-green-800">
                                    <div>The task has been completed.</div>
                                </div>
                            @elseif ($channel->is_task_started === 'true' && $channel->is_task_completed === 'pending')
                                <div class="h-12 flex items-center rounded-t-lg rounded-b-none shadow-sm p-6 bg-yellow-100 text-yellow-800">
                                    <div>Waiting for seeker to confirm task completion.</div>
                                </div>
                            @elseif ($channel->is_task_started === 'true')
                                <div class="h-12 flex items-center rounded-t-lg rounded-b-noneshadow-sm p-6 bg-yellow-100 text-yellow-800">
                                    <div>The task is in progress.</div>
                                </div>
                            @elseif ($channel->is_arrived === 'true')
                                <div class="h-12 flex items-center rounded-t-lg rounded-b-none shadow-sm p-6 bg-blue-100 text-blue-800">
                            ...
                            <div class="border bg-custom-lightestblue-accent p-6 rounded-b-lg flex justify-between items-center">
                                <div class="">
                                ...
                                <div class="space-y-4">
                                    ...
                                    @elseif ($channel->is_task_started === 'true')
                                        <p class="text-white">Task is currently in progress. Wait for the provider to
                                            ...
                                            @forelse ($assignedEmployees as $employee)
                                                <li
                                                    ...
                                                    <div class="flex items-center space-x-4">
                                                        ...
                                                        @endif
                                                        <span
                                                            class="text-lg font-medium">{{ $employee->name }}</span>
                                                    </div>
...
{{-- Provider Details --}}
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="flex justify-end pt-4">
                                                ...
                                                <div class="bg-yellow-50 rounded-lg border p-6 mt-6 w-full text-gray-700">
                                                    <div class=" pb-4 mb-4">
                                                        <div class="flex items-center space-x-2 text-2xl border-b pb-4 mb-4">
                    ...
                    <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50"
                        id="arrivalModal" style="display: none;">
                        <div class="bg-white rounded-lg shadow-lg w-full max-w-lg mx-auto p-6 md:max-w-md">
                            ...
                            <div class="flex justify-end">
                                <button type="button"
                                    class="bg-gray-500 text-white px-4 py-2 rounded mr-2 hover:bg-gray-700"
                    ...
                    <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50"
                        id="startTaskModal" style="display: none;">
                        <div class="bg-white rounded-lg shadow-lg w-full max-w-lg mx-auto p-6 md:max-w-md">
                            <div class="flex justify-between items-center border-b pb-4 mb-4">

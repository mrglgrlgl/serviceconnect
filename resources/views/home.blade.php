<x-app-layout>
    ...
    <div class="max-w-screen-lg mx-auto">
        <form method="GET" action="{{ route('provider.search') }}" class="w-full">
            ...
            {{-- Filter Section --}}
            <div class="border-2 rounded-t-lg w-full mx-auto flex flex-wrap items-center justify-center p-4 space-y-4 md:space-y-0 md:space-x-4 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 w-full mx-auto pb-6" style="min-height: 60vh;">
                <!-- Map -->

<x-seekerhome>
    ...
    <form method="POST" action="{{ route('register') }}" class="grid items-center justify-center sm:pt-0 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 w-10/12 mx-auto pb-6">
            <!-- Map -->
            <div id="map" class="h-80 md:h-144 w-full md:shadow-md md:col-span-1 order-1 md:order-2 rounded-t-lg md:rounded-none"></div>
            ...
            <div class="p-4 bg-white shadow-md md:col-span-2 order-2 md:order-1 rounded-b-lg md:rounded-none overflow-y-auto">
                ...
                <div class="pt-4">
                    <div class="relative shadow-sm">
                        <input type="text" id="provider-search" class="w-full rounded-3xl h-12 border border-custom-fields focus:border-custom-dark-blue pl-4 pr-10" placeholder="Search...">

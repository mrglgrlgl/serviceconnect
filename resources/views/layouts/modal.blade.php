...
<x-text-input type="time" class="mt-1 block w-full sm:text-sm rounded-md" id="start_time" name="start_time" value="09:00" required/>
                        </div>
                        <div>
                            <label for="end_time" class="form-label">End Time <span class="text-red-500">*</span></label>
<x-text-input type="time" class="mt-1 block w-full sm:text-sm rounded-md" id="end_time" name="end_time" value="17:00" />
                        </div>
                    </div>-->
  ...
  <!--  <div class="flex-1">
        ...
        <x-text-input type="number" class="mt-1 block w-full sm:text-sm rounded-md" id="estimated_duration" name="estimated_duration" value="" required />
                    ...
                    <div class="file-upload-container">
                        <label class="form-label text-lg text-gray-800"><strong>Attach Task Photos 
                        {{-- <span class="text-red-500">*</span></strong> (At least 1 required) --}}
                        </label>

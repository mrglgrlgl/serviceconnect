<aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l ">
    <a href="#">
        <img class="w-auto h-7" src="{{ asset('images/horizontal-logo.png') }}" alt="">
    </a>
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="-mx-3 space-y-6 ">
            <div class="space-y-3 ">
             <label class="px-3 text-xs text-gray-500 uppercase">Service Requests</label>
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-gray-100  hover:text-gray-700" href="#">
                    ...
                    <span class="mx-2 text-sm font-medium">Open Requests</span>
                </a>
            ...
            <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-gray-100  hover:text-gray-700" href="#">
                ...
                <span class="mx-2 text-sm font-medium">Accepted Requests</span>
            </a>
        </div>
                ...
                {{-- <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-gray-100   hover:text-gray-700" href="#">
                    ...
                    <span class="mx-2 text-sm font-medium">Employee Performance</span>
                </a>
            </div> --}}

            <div class="space-y-3 ">
                <label class="px-3 text-xs text-gray-500 uppercase">Monitoring</label>

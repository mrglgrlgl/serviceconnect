    ...
    <div class="py-12">
        <div class="w-full md:w-10/12 lg:w-8/12 xl:w-8/12 2xl:w-7/12 mx-auto">
            ...
            @if (Auth::check() && Auth::user()->role == 2)
                <!-- Profile completeness and certifications message -->
                ...
                @if (isset(Auth::user()->providerDetails) && $certificationsCount > 0)
                    <div class="bg-green-100 text-green-700 p-4 rounded mb-6">
                        Your profile is complete.
                        <a href="{{ route('certifications') }}" class="text-blue-500 underline">Add more certifications</a>
                    </div>
                @endif
                ...
                @else
                    @foreach ($serviceRequests as $serviceRequest)
                        ...
                        <!-- Display service requests including direct hires assigned to the current provider -->
                        @if (!$serviceRequest->is_direct_hire || ($serviceRequest->is_direct_hire && $serviceRequest->provider_id == Auth::user()->id))
